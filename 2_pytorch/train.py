...
def train(epoch):
    ...
    for batch_idx, batch in enumerate(train_loader):
        ...
        #############################################################################
        optimizer.zero_grad()
        scores_matrix = model.forward(images)
        loss = criterion(scores_matrix, targets)
        loss.backward()
        optimizer.step()
        # above code is adapted from https://pytorch.org/tutorials/beginner/blitz
        # /cifar10_tutorial.html#sphx-glr-beginner-blitz-cifar10-tutorial-py
        #############################################################################
        #                             END OF YOUR CODE                              #
        #############################################################################
